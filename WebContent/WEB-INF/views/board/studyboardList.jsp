...
<body>
	...
	<div class="www" align="center">
		...
		<table id="mmm">
			<tr>
				...
				<th class="ts" id="st" onclick="location.href='list.st'">스터디모집</th>
			</tr>
		</table>
	</div>
	...
	<div id="search" align="center">
		<select name="search">
			<option value="study_title" selected>제목</option>
			<option value="study_writer">작성자</option>
			<option value="study_region">지역</option>
		</select>
...
<%--    <div class="ot" align="center">  --%>
		...
		<div class="tableArea">
			<table id="listArea">
				<tr>
					...
					<th class="nt" width="80px" height="40px;">번호</th>
					<th class="nt" width="460px" height="40px;">제목</th>
					<th class="nt" width="150px" height="40px;">작성자</th>
					<th class="nt" width="200px" height="40px;">지역</th>
					<th class="nt" width="150px" height="40px;">등록일</th>
					<th class="nt" width="60px" height="40px;">조회수</th>
				</tr>
				<% if(flist.isEmpty()){ %>
					<tr>
	...
	<div id="btnarea" align="right">
		<% if(loginMember != null){ %>  
				<button onclick="location.href='<%= request.getContextPath() %>/writeBoardForm.st'" id="writeFboBtn">글쓰기</button>
		<% } %> 			
	</div>
