...
<body>
	...
	<div class="outer">
		<br>
		<h2>자유글 게시판 글쓰기</h2><hr>
		<div class="tableArea">
			<form action="<%= request.getContextPath() %>/insert.fbo" method="post">
				<%-- 
				<label>게시판 종류 : </label>
				...
				<div align="center">
					...
					<input type="button" id="cancelBtn" onclick="location.href='<%= request.getContextPath() %>/list.fbo'" value="취소">
				</div>
			</form>
		</div>
	</div>
